...
public class SQSPut extends Thread {
    String q = "";
    AmazonSQSClient conn;
    int message_size = 16;
    int message_count = 1;

    public SQSPut(DLCConnect cn, String q ) {
         super();
         this.conn  =   cn.ConnectSQS(cn.getEnv(),cn.getRegion());
         this.q  = q;
    }
    public SQSPut(DLCConnect cn, String q, int size, int count) {
         super();
         this.conn  =   cn.ConnectSQS(cn.getEnv(),cn.getRegion());
         this.q  = q;
    ...
    public SQSPut(AmazonSQSClient conn, String q ) {
         super();
         this.conn = conn;
         this.q  = q;
    }
    public SQSPut(AmazonSQSClient conn, String q, int size, int count) {
         super();
         this.conn = conn;
         this.q  = q;
         this.message_size = size;
    ...
    public void run(){
         int i = 0;
         String sz = Helper.randomString(this.message_size);
         for (i=0;i<this.message_count;i++)
              this.conn.sendMessage(new SendMessageRequest(this.q, sz));
     }
}
