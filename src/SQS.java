...
public class SQS {
     public static void main(String[] args) {
          SQSSender q = new SQSSender();
     }
}

class SQSSender {
     public SQSSender() {
          DLCConnect cn = new DLCConnect("EAISBX", "E1", "", "","");
          AmazonSQSClient conn  =   cn.ConnectSQS(cn.getEnv(),cn.getRegion());
          for (int i = 0;i<12;i++)
               conn.sendMessage(new SendMessageRequest("https://sqs.us-east-1.amazonaws.com/343742945353/ECETESTQUEUE", "This is my message text"));
     }
}
